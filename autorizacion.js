async function generarAutorizacionPDF() {
    ...
    const mandatarioNombre = document.getElementById("mandatario_nombre").value;
    const mandatarioDni = document.getElementById("mandatario_dni").value;
    const mandatarioDomicilio = document.getElementById("mandatario_domicilio").value;
    const mandatarioLocalidad = document.getElementById("mandatario_localidad").value;
    ...
    doc.text("Mandatario Interviniente", 135, 143);
    ...
    // Datos mandatario
    doc.text(`D.N.I: ${mandatarioDni}`, 120, 153);
    doc.text(`Domicilio: ${mandatarioDomicilio}`, 120, 160);
    doc.text(`Localidad: ${mandatarioLocalidad}`, 120, 167);
